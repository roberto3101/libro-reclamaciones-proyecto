    ...
    <div style={est.contenedor}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
        ...
        <span style={{
          ...
          padding: '4px 12px', borderRadius: 'var(--ui-r-lg)', fontSize: '0.75rem', fontWeight: 700,
        }}>
          {uso.plan_nombre}
      ...
      <a href="/suscripcion" style={{
        ...
        fontSize: '0.8rem', color: C.primarioTexto, fontWeight: 600, textDecoration: 'none',
      }}>
...
const est = {
  contenedor: {
    background: 'var(--ui-superficie)', borderRadius: 'var(--ui-r-xl)', padding: 20, border: `1px solid ${C.borde}`,
