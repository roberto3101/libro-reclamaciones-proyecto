...
export default function TarjetasPlanes({ planActualCodigo, onSeleccionar, soloLectura }: Props) {
  ...
  return (
    <div style={est.contenedor}>
        ...
        {planesVisibles.map((plan) => {
          ...
          return (
            ...
            >
              ...
              {esActual && <div style={{ ...est.badge, background: 'var(--ui-exito)' }}>Tu plan actual</div>}
              ...
              <div>
                <div style={{ display: 'flex', alignItems: 'baseline', gap: 4 }}>
                  <span style={{ fontSize: '2.25rem', fontWeight: 600, fontFamily: 'var(--ui-fuente-titulo)', fontVariantNumeric: 'tabular-nums', color: colores.texto }}>{formatoMoneda(precioMostrar)}</span>
                ...
                {ciclo === 'ANUAL' && ahorro > 0 && (
                  <span style={{ background: 'var(--ui-adv-suave)', color: 'var(--ui-adv-texto)', padding: '4px 12px', borderRadius: 'var(--ui-r-lg)', fontSize: '0.8rem', fontWeight: 600, display: 'inline-block' }}>
      ...
      <div style={{ marginTop: 40, maxWidth: '58ch', color: colores.textoSecundario, fontSize: '0.85rem' }}>
