...
import { guiaSuscripcion } from '@/componentes/ui/guias-contenido';
                ...
                <tbody>
                  {historial.map((s) => (
                    <tr key={s.id}>
                      ...
                      <td style={est.td}>{s.activado_por_usuario_nombre || etiquetaActivadoPor[s.activado_por ?? ''] || s.activado_por || '—'}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
