                ...
                <tr key={plan.id} style={{ opacity: plan.activo ? 1 : 0.5 }}>
                  ...
                  <td style={est.td}>
                    <span style={{
                      ...
                      fontSize: '0.75rem',
                      fontWeight: 600,
                      background: plan.activo ? 'var(--ui-exito-suave-2)' : 'var(--ui-peligro-suave)',
                      color: plan.activo ? C.exitoTexto : C.peligroTexto,
                    }}>
                  ...
                  <td style={est.td}>
                    <div style={{ display: 'flex', gap: 8 }}>
                      ...
                      <button
                        style={{ ...est.btnAccion, color: plan.activo ? C.peligroTexto : C.exitoTexto }}
...
const est = {
  ...
  code: { background: 'var(--ui-hover)', padding: '2px 8px', borderRadius: 4, fontSize: '0.8rem' },
  badgeDest: {
    background: 'var(--ui-adv-suave)', color: 'var(--ui-adv-texto)', padding: '2px 6px', borderRadius: 4,
    fontSize: '0.7rem', marginLeft: 6,
  },
  btnPrimario: {
    padding: '10px 24px', border: 'none', borderRadius: 'var(--ui-r-lg)', cursor: 'pointer',
    fontWeight: 700, fontSize: '0.85rem', background: C.primario, color: '#fff',
  } as React.CSSProperties,
  btnSecundario: {
    padding: '10px 24px', border: `1px solid ${C.borde}`, borderRadius: 'var(--ui-r-lg)', cursor: 'pointer',
    fontWeight: 600, fontSize: '0.85rem', background: 'var(--ui-superficie)', color: C.texto,
  } as React.CSSProperties,
  btnAccion: {
    padding: '4px 12px', border: 'none', background: 'none', cursor: 'pointer',
    color: C.primarioTexto, fontWeight: 600, fontSize: '0.8rem',
  } as React.CSSProperties,
  gridForm: {
  ...
  input: {
    width: '100%', padding: '8px 12px', border: `1px solid ${C.borde}`, borderRadius: 'var(--ui-r-lg)',
